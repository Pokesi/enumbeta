...
const createThemeMode = isNightMode =>
  createTheme({
    palette: {
      ...
      background: {
        default: isNightMode ? '#120309' : '#246A73',
        paper: isNightMode ? '#3E311A' : '#fff',
        primary: isNightMode ? '#3E311A' : '#368F8B',
        secondary: isNightMode ? '#3B3A4D' : '#AE8CA3',
      ...
      text: {
        primary: isNightMode ? '#fff' : '#F4EBD9',
