export const stratAbi = [
  {
    inputs: [
      ...
      { internalType: 'address[]', name: '_outputToNativeRoute', type: 'address[]' },
      { internalType: 'address[]', name: '_outputToLp0Route', type: 'address[]' },
      { internalType: 'address[]', name: '_outputToLp1Route', type: 'address[]' },
    ],
